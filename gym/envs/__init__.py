...
register(
    id="InvertedPendulum-Target-v1",
    entry_point="gym.envs.mujoco:InvertedPendulumTargetEnv",
    max_episode_steps=1000,
    reward_threshold=950.0,
)

register(
    id="InvertedPendulum-Target-v2",
    entry_point="gym.envs.mujoco:InvertedPendulumTargetEnv2",
    max_episode_steps=1000,
    reward_threshold=950.0,
)

register(
    id="InvertedPendulum-Target-v3",
    entry_point="gym.envs.mujoco:InvertedPendulumTargetEnv3",
    max_episode_steps=1000,
    reward_threshold=950.0,
)
...
register(
    ...
    entry_point="gym.envs.mujoco:InvertedPendulumEnv3",
    max_episode_steps=1000,
    reward_threshold=950.0,
)
...
register(
    ...
    entry_point="gym.envs.mujoco:InvertedPendulumEnv4",
    max_episode_steps=1000,
    reward_threshold=950.0,
)
...
register(
    ...
    entry_point="gym.envs.mujoco:InvertedPendulumEnv5",
    max_episode_steps=1000,
    reward_threshold=950.0,
)
